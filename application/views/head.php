...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php  echo base_url();?>css/ui-lightness/jquery-ui-1.10.3.custom.css">
	...
	<?php /*<script type="text/javascript" src="<?php echo base_url()?>js/loading.js"></script> */?>
